...
import type { APIPaginatedResponse, PaginatedResponse } from "@/shared/domain/api/types/pagination.types";
import axios from "axios";

import { API_URL } from "@shared/config";
import { Application } from "@applications/domain/entity/application";
import type { IApplicationRepository, GetParams } from "@applications/domain/repository";


export class ApplicationRepository implements IApplicationRepository {
  public constructor() { }

  public async get(params: GetParams): Promise<PaginatedResponse<Application>> {
    try {
